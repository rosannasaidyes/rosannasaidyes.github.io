...
Webflow.require('ix').init([
  {"slug":"hover-link","name":"Hover Link","value":{"style":{},"triggers":[{"type":"hover","stepsA":[{"transition":"transform 200ms ease 0ms","x":"0px","y":"-1px"}],"stepsB":[{"transition":"transform 200ms ease 0ms","x":"0px","y":"1px"}]}]}},
  {"slug":"fade-in-first","name":"Fade In First","value":{"style":{"display":"block","opacity":0},"triggers":[{"type":"load","stepsA":[{"opacity":1,"transition":"opacity 1000ms ease-in 0ms"}],"stepsB":[]}]}},
  {"slug":"move-up-load","name":"Move Up Load","value":{"style":{"opacity":0,"x":"0px","y":"20px"},"triggers":[{"type":"load","stepsA":[{"opacity":1,"transition":"transform 1000ms ease-in 0ms, opacity 2000ms ease-in 0ms","x":"0px","y":"1px"}],"stepsB":[]}]}}
]);
